    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-6 border-t border-gray-200 dark:border-gray-700">
        <button
          ...
          className="w-full px-4 py-3 bg-gray-100 dark:bg-dark-hover text-gray-900 dark:text-white rounded-lg hover:bg-gray-200 dark:hover:bg-dark-card transition-colors font-semibold"
        >
          Clear All Filters
        </button>
      </div>
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="lg:hidden fixed left-0 top-0 bottom-0 w-80 bg-white dark:bg-dark-card z-50 shadow-2xl"
      >
        {sidebarContent}
      </motion.aside>

      {/* Desktop Sidebar */}
      <aside className="hidden lg:block w-80 bg-white dark:bg-dark-card rounded-2xl shadow-lg sticky top-24 h-fit">
        {sidebarContent}
      </aside>
    </>
  );
