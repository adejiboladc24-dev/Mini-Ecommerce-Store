...
const Home = () => {
  ...
  return (
    <div className="min-h-screen mesh-gradient">
      ...
      {/* Ultra Busy Promotional Banner */}
      <section className="relative overflow-hidden bg-gradient-to-r from-red-600 via-pink-600 to-purple-600 border-y-4 border-yellow-400">
        ...
        <motion.div
          ...
          className="absolute top-2 left-10 text-4xl"
        >
          🔥
        </motion.div>
        <motion.div
          ...
          className="absolute top-2 right-10 text-4xl"
        >
          ⚡
        </motion.div>
        <motion.div
          ...
          className="absolute bottom-2 left-1/4 text-3xl"
        >
          💎
        </motion.div>
        <motion.div
          ...
          className="absolute bottom-2 right-1/4 text-3xl"
        >
          ✨
        </motion.div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4 py-4 sm:py-5">
            {/* Left Side - Multiple Badges */}
            <div className="flex flex-wrap items-center justify-center gap-2">
              <motion.div
                animate={{ scale: [1, 1.1, 1] }}
                transition={{ duration: 1, repeat: Infinity }}
                className="flex items-center gap-1.5 px-3 py-1.5 bg-yellow-400 text-black rounded-full font-black text-xs shadow-lg"
              >
                <Zap size={14} className="animate-pulse" />
                FLASH SALE
              </motion.div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white/20 backdrop-blur-sm rounded-full border-2 border-white text-white font-bold text-xs">
                <div className="w-2 h-2 rounded-full bg-green-400 animate-ping"></div>
                <div className="w-2 h-2 rounded-full bg-green-400 absolute"></div>
                LIVE NOW
              </div>
              <div className="hidden sm:flex items-center gap-1 px-3 py-1.5 bg-red-500 text-white rounded-full font-bold text-xs animate-pulse">
                🎯 HOT DEALS
              </div>
            </div>
            ...
            <div className="text-center flex-1">
              ...
              >
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-black text-white drop-shadow-lg">
                  <span className="inline-block animate-bounce">🎁</span>
                  <span className="mx-1 sm:mx-2">MEGA SALE:</span>
                  <span className="px-2 sm:px-4 py-1 sm:py-2 bg-yellow-400 text-black rounded-lg text-lg sm:text-xl md:text-2xl lg:text-3xl font-black shadow-2xl inline-block transform hover:scale-110 transition-transform">
                    UP TO 70% OFF
                  </span>
                  <span className="mx-1 sm:mx-2 hidden sm:inline">+ FREE SHIPPING</span>
                  <span className="inline-block animate-bounce">🎉</span>
                </p>
              </motion.div>
              <p className="text-xs sm:text-sm text-white/90 font-semibold mt-1 animate-pulse">
                ⏰ Limited Time Only • While Stocks Last • Don't Miss Out!
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2">
              <Link 
                to="/products" 
                className="group relative px-4 sm:px-6 py-2 sm:py-3 bg-yellow-400 hover:bg-yellow-300 text-black rounded-full font-black text-sm sm:text-base shadow-2xl transition-all hover:scale-110 hover:shadow-yellow-400/50 whitespace-nowrap overflow-hidden"
              >
              ...
              <motion.div
                ...
                className="hidden sm:block px-3 py-2 bg-white/20 backdrop-blur-sm border-2 border-white text-white rounded-full font-bold text-xs"
              >
                🏃 HURRY!
              </motion.div>
            </div>
        ...
        {/* Bottom ticker */}
        <div className="bg-black/30 backdrop-blur-sm py-1 overflow-hidden">
          <motion.div
            animate={{ x: [0, -1000] }}
            transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
            className="flex gap-8 whitespace-nowrap text-white text-xs font-bold"
          >
            {[...Array(10)].map((_, i) => (
              <span key={i} className="flex items-center gap-2">
                ⭐ BEST PRICES ⭐ FREE DELIVERY ⭐ 24/7 SUPPORT ⭐ SECURE PAYMENT ⭐
              </span>
            ))}
          </motion.div>
        </div>
